/***********************************************************************************
 * Fichero alojamientos.hpp para la definición de atributos y métodos de la clase
...
#ifndef ALOJAMIENTOS_HPP_
#define ALOJAMIENTOS_HPP_

// INCLUIR aquí todas las bibliotecas necesarias
...
// -------- MÉTODOS PÚBLICOS DE LA CLASE Alojamientos
        ...
        Alojamientos &operator=(const Alojamientos &otro_objeto);
